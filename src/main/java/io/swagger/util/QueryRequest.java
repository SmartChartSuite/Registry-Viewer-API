...
public enum QueryRequest {
    ...
    TIMED_OUT(0x0008, "TIMED_OUT", "Retry count reached the maximum allowed count. Giving up.", "timed-out", "Job taking longer than expected. This may indicate a temporary network error. If this error persists, please contact technical support. (0x0008)."), 
    PAUSED(0x0010, "PAUSED", "Case is paused by system admin.", "paused","Case is paused by system administrator. (0x0010)"), 
